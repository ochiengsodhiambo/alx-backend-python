...
SECRET_KEY = 'django-insecure-7v+l89+vm)(^t-rconf#kn#nz_#x((x+7o^hhgdwf856avm2sy'
...
# Use our custom user model (we will create it soon)
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_PERMISSION_CLASSES": (
        "chats.permissions.IsAuthenticatedOrAdminSafe",
    ),
